...
\newtcolorbox{readaloud}[1][]{enhanced,breakable,colback=mist,colframe=blood!75!black,colbacktitle=blood!75!black,coltitle=white,boxrule=0.6pt,arc=0mm,left=3mm,right=3mm,top=2mm,bottom=2mm,title={Da leggere ad alta voce},fonttitle=\sffamily\small\bfseries,#1}
...
\subsection{Come consultare i nodi}
Ogni nodo segue lo stesso ordine: \textbf{A colpo d'occhio}, \textbf{Arrivo e ambienti}, \textbf{Interazioni e ostacoli}, \textbf{Handout}, \textbf{Evoluzione della scena}, \textbf{Collegamenti}. I blocchi interni seguono le esigenze del luogo; l'ordine di consultazione non impone una sequenza ai giocatori.

I riquadri \textbf{Da leggere ad alta voce} contengono descrizioni e battute da leggere o parafrasare quando si verifica la situazione indicata. Adattali a ingresso, presenze e informazioni già note ai PG. Le indicazioni esterne ai riquadri sono riservate al GM. Aspetti, azioni in Fate e compel accompagnano gli ambienti o le interazioni pertinenti.

La voce \textbf{Handout} nel quadro iniziale è un indice rapido. Le schede complete si trovano sempre nella sezione omonima, dopo le interazioni: \textbf{Dove}, \textbf{Quando consegnarlo}, \textbf{Che cosa rivela}, \textbf{Limiti}. I rimandi durante la scena aiutano a ritrovarle; la posizione nel capitolo non ritarda la consegna ai giocatori.
...
\textbf{Per il GM:} la casa è stata abitata e riordinata durante la settimana. Minestra e tazza appartengono alla giornata corrente. Il cappotto è un ricambio, non una prova di ritorno. La manica copre il livido della crisi. L'ordine domestico mostra lo sforzo di Eleanor di continuare; non nasconde un enigma.
...
\subsubsection{H01 -- Appunti sparsi}
...
\subsubsection{H02 -- Cartina annotata}
...
\textbf{Per il GM:} la cassa in lavorazione è una spedizione ordinaria, non la 17. Il rumore rende difficile parlare nel reparto; l'ufficio consente di leggere e conversare. Gli operai stanno lavorando e non conoscono automaticamente il segreto della commessa.
...
\subsubsection{H04 -- Registro di pesatura}
...
\subsubsection{H05 -- Ricevuta di trasferimento}
...
\textbf{Per il GM:} quando si nomina l'incendio, Silas depone l'utensile. Quando la conversazione riguarda l'invenzione, può mostrare il vecchio regolatore e H03. Non lasciarli descritti come oggetti misteriosi da individuare con un tiro.
...
\subsubsection{H03 -- Progetto del regolatore}
...
\subsubsection{H06 -- Registro delle commesse}
...
\subsubsection{H06a -- Spedizione 44-14}
...
\subsubsection{H06b -- Disegno 44-12}
...
\subsubsection{H07 -- Disposizione interna riservata}
...
\subsubsection{H08 -- Referto di visita non protocollato}
...
\subsubsection{H09 -- Nota mai spedita}
...
\subsubsection{H10 -- Avviso di caccia}
...
\subsubsection{H11 -- Note sulla runa}
...
\subsubsection{H11b -- Preghiera tradotta e commentata da Willem}
...
\subsubsection{H13 -- Inventario del deposito}
...
\subsubsection{H14 -- Schema degli accessi}
...
\subsubsection{H12 -- Scoperte e dubbi di Elias}
...
\subsubsection{H15 -- Schema della macchina}
...
\subsubsection{H16 -- Rapporto sul Progetto}
