...
\item Elias conserva H12 con le scoperte e i dubbi personali. H14 è lo schema di servizio che ha consultato; H15 e H17 distinguono macchina, regolatore e organismo. Non sono istruzioni per un salvataggio coordinato.
...
Controlli & Ingresso di servizio sul deposito; porta sorvegliata verso l'ascensore. La chiave di Silas apre soltanto l'ingresso di servizio.\\
...
Documenti & H13 presso la registrazione delle consegne; H14 affisso nel settore controllato dell'ascensore, al piano del deposito.\\
...
\subsection{Il Laboratorio in attività}
\begin{rulebox}
L'edificio sorge accanto all'Ospedale. Ai tavoli il personale misura e travasa le preparazioni, poi riordina recipienti e strumenti per il lavoro successivo. Le casse non occupano quei tavoli: vengono portate nel deposito, dove le consegne sono registrate prima di essere distribuite.

Chi vi riceve chiede il motivo della visita. Il lavoro continua mentre spiegate che cosa state cercando.
\end{rulebox}
...
\begin{rulebox}
Nel deposito le casse sono separate dai recipienti già destinati ai tavoli di lavoro. Le carte delle consegne rimangono vicino al punto in cui si controlla il materiale ricevuto. L'ingresso di servizio dà direttamente su questo settore; più avanti, il sorvegliante controlla la porta che conduce all'ascensore merci.

Il movimento delle forniture prosegue oltre quella porta, ma i visitatori non vengono invitati a seguirlo.
\end{rulebox}

\textbf{H13 -- Inventario del deposito:} si trova presso la registrazione delle consegne, non addosso alla guardia. Chi verifica una fornitura con l'addetto può farsi mostrare la voce pertinente. Se i PG cercano di leggerlo senza permesso, stabilisci come raggiungono le carte e chi può vederli. Non richiedere che abbiano già dimostrato il trasferimento prima di mostrare il documento che lo prova.
...
\textbf{Chiave di Silas:} apre l'ingresso di servizio sul deposito, non la porta controllata o l'ascensore. Possederla non rende vuoto l'edificio.
...
\begin{rulebox}
Oltre la porta controllata, lo spazio davanti all'ascensore permette di accostare le casse prima di caricarle. Sulla parete è affisso uno schema di servizio: distingue la scala dell'Ospedale dalla galleria delle forniture. Un altro collegamento raggiunge le fogne, attraverso lo scarico del vano di manutenzione. Sotto il disegno sono riportate le avvertenze per il lavaggio.
\end{rulebox}
...
\textbf{Limite della ricostruzione:} questa dinamica spiega l'ingresso, non il successivo nascondiglio o il motivo della permanenza. Quei punti rimangono da definire nel finale; non aggiungere una fuga o un sabotaggio per colmarli.
...
\textbf{H12 -- Scoperte e dubbi di Elias}

\textit{Come si ottiene:} rimane fra gli appunti personali che Elias porta con sé. Può mostrarlo durante il colloquio se i PG chiedono di ricostruire ciò che ha scoperto.

\textit{Scopo e limite:} distingue osservazioni, informazioni ricevute e dubbi. La consegna è facoltativa: non è necessaria per accedere al complesso o comprendere le sue parole, e non definisce un piano successivo.
