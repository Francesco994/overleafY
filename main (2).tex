...
% ================================================================
% STILE DEL MANUALE: modificare qui colori, cornici e spaziature.
% I riquadri condividono dimensioni e gerarchie; ogni tipo ha un segno
% distinto. Tutti consentono la prosecuzione sulla pagina successiva.
% ================================================================
\definecolor{vellum}{HTML}{F6F0E3}
\definecolor{brass}{HTML}{91754B}

\newcommand{\yhdivider}{%
  \par\nobreak\noindent
  {\color{blood!55}\hrulefill\hspace{2mm}%
   \raisebox{-.2ex}{\small\(\diamond\)}%
   \hspace{2mm}\hrulefill}\par\nobreak}

% Fregi dei riquadri da leggere: solo sui veri bordi iniziale/finale.
\newcommand{\yhcornertop}{%
  \draw[blood!65,line width=.35pt]
    ([xshift=1mm,yshift=-4mm]frame.north west)
    --([xshift=1mm,yshift=-1mm]frame.north west)
    --([xshift=4mm,yshift=-1mm]frame.north west);
  \draw[blood!65,line width=.35pt]
    ([xshift=-4mm,yshift=-1mm]frame.north east)
    --([xshift=-1mm,yshift=-1mm]frame.north east)
    --([xshift=-1mm,yshift=-4mm]frame.north east);}
\newcommand{\yhcornerbottom}{%
  \draw[blood!65,line width=.35pt]
    ([xshift=1mm,yshift=4mm]frame.south west)
    --([xshift=1mm,yshift=1mm]frame.south west)
    --([xshift=4mm,yshift=1mm]frame.south west);
  \draw[blood!65,line width=.35pt]
    ([xshift=-4mm,yshift=1mm]frame.south east)
    --([xshift=-1mm,yshift=1mm]frame.south east)
    --([xshift=-1mm,yshift=4mm]frame.south east);}

\tcbset{
  yhbase/.style={
    enhanced,breakable,arc=0mm,boxrule=.45pt,
    left=4mm,right=4mm,top=3mm,bottom=3mm,
    before skip=9pt,after skip=9pt,
    fonttitle=\sffamily\small\bfseries,
    toptitle=1.5mm,bottomtitle=1.5mm},
  yhquiet/.style={
    yhbase,colback=mist,colframe=iron!45,
    colbacktitle=ash,coltitle=ink},
  yhblood/.style={
    yhbase,colback=ash!35,colframe=blood,
    colbacktitle=blood,coltitle=white}
}

\titleformat{\section}{\displayfont\Large\bfseries\color{blood}}{}{0pt}{}[\yhdivider]
\titleformat{\subsection}{\displayfont\large\bfseries\color{ink}}{}{0pt}{}[\vspace{-1mm}{\color{brass!65}\titlerule[.35pt]}]
...
\newtcolorbox{readaloud}[1][]{
  yhbase,colback=vellum,colframe=blood!70!black,
  colbacktitle=vellum,coltitle=blood,
  borderline={.3pt}{1.2pt}{brass!75},
  left=5mm,right=5mm,top=3.5mm,bottom=3.5mm,
  toptitle=3mm,bottomtitle=2mm,
  title={DA LEGGERE AD ALTA VOCE},
  overlay unbroken={\yhcornertop\yhcornerbottom},
  overlay first={\yhcornertop},
  overlay middle={},
  overlay last={\yhcornerbottom},#1}
\newtcolorbox{bloodbox}[1][]{yhblood,#1}
\newtcolorbox{gmbox}[1][]{
  yhquiet,boxrule=0pt,leftrule=1.2pt,colframe=blood,
  colback=mist,colbacktitle=ash,coltitle=ink,
  title={DIETRO LA SCENA -- GM},#1}
\newtcolorbox{cluebox}[1][]{
  yhbase,colback=white,colframe=brass,
  colbacktitle=vellum,coltitle=ink,
  title={INFORMAZIONI E INDIZI},#1}
\newtcolorbox{fatebox}[1][]{
  yhquiet,leftrule=1.2pt,colframe=iron,
  title={FATE -- ASPETTI, AZIONI E COMPEL},#1}
\newtcolorbox{clockbox}[1][]{
  yhblood,title={EVOLUZIONE -- SE IL TEMPO AVANZA},#1}
\newtcolorbox{overviewbox}{
  yhquiet,colback=pale,boxrule=.4pt,
  left=3mm,right=3mm,top=2mm,bottom=2mm}
\newtcolorbox{routebox}{
  yhbase,colback=vellum!55!white,colframe=brass!70,
  boxrule=0pt,toprule=.6pt,bottomrule=.6pt}
\newtcolorbox{handoutbox}[2]{
  yhbase,colback=pale,colframe=brass,
  colbacktitle=vellum,coltitle=ink,
  title={\colorbox{blood}{\strut\textcolor{white}{\enspace #1\enspace}}%
    \quad #2},
  fontupper=\normalfont}

\newcommand{\nodehead}[3]{%
\clearpage
{\titleformat{\section}{\displayfont\huge\bfseries\color{blood}}{}{0pt}{}[\yhdivider]%
\section{#1}}
